...
export default function AddPatientView({ 
  ...
  const [openSections, setOpenSections] = useState<Record<string, boolean>>({
    ...
    tumorCharacteristics: false,
    clinicalStaging: false,
    histologyGrading: false,
    adjuvantTherapy: false,
    preOperativeAssessment: false,
    definitiveSurgery: false,
    treatmentOutcome: false,
    afterSurgicalTherapies: false,
    followUpPrognosis: false,
    oncologicalOutcome: false,
    supplementary: false,
    treatments: false,
