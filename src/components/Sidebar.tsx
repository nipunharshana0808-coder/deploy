  ...
  return (
    <>
      ...
      <div className="lg:hidden flex items-center gap-2 glass-header px-4 py-3 sticky top-0 z-30 transition-colors duration-200">
        ...
        <div className="h-8 w-8 bg-natural-accent rounded-lg flex items-center justify-center text-theme-on-accent">
          <Activity className="h-5 w-5 animate-pulse" />
        </div>
        <span className="font-bold text-natural-accent-dark dark:text-theme-on-accent ">AI DMS</span>
      </div>
      ...
      `} style={mobileOpen ? undefined : { animation: "none" }}>
        ...
        <div>
          <div className="flex items-center justify-between lg:justify-start gap-3 mb-4">
            <div className="flex items-center gap-3">
              <div className="premium-icon-tile h-10 w-10 bg-natural-accent rounded-xl flex items-center justify-center text-theme-on-accent shadow-sm">
          ...
          <div className="mb-6 rounded-2xl border border-theme-highlight/10 bg-theme-surface/20 dark:bg-slate-950/30 p-4 text-sm text-slate-700 dark:text-slate-200">
            <p className="font-semibold text-slate-900 dark:text-theme-on-accent">Signed in as</p>
              ...
              return (
                <button
                  ...
                  className={`
                    ...
                    ${isActive
                      ? "bg-natural-accent text-theme-on-accent font-semibold shadow-sm"
                      : "text-slate-600 dark:text-slate-400 hover:bg-natural-hover hover:text-natural-accent-dark dark:hover:text-theme-on-accent"
                    }
                  `}
                >
        ...
        <div className="space-y-3 pt-4 border-t border-natural-border">
          <button
            id="btn-signout"
            onClick={onSignOut}
            className="w-full flex items-center justify-between px-3.5 py-2.5 rounded-lg text-xs font-semibold text-rose-700 dark:text-rose-405 bg-theme-surface/60 dark:bg-rose-950/20 hover:bg-rose-50 dark:hover:bg-rose-955/45 border border-natural-border cursor-pointer text-left hover-lift ripple-on-click"
          >
