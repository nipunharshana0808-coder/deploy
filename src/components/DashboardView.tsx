...
export default function DashboardView({ allPatients }: DashboardViewProps) {
  ...
  return (
    <div className="space-y-6 ">
      ...
      {/* Title Header */}
      <div>
        <h2 className="text-2xl font-bold text-slate-800 dark:text-theme-on-accent tracking-tight leading-tight">Clinical Dashboard & Metrics</h2>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <div className="glass-card p-4 rounded-2xl flex flex-col justify-between group">
          ...
          <div className="mt-4">
            <h3 className="text-3xl font-bold text-slate-800 dark:text-theme-on-accent tracking-normal leading-none">{total}</h3>
        ...
        <div className="glass-card p-4 rounded-2xl flex flex-col justify-between">
          ...
          <div className="mt-4">
            <h3 className="text-3xl font-bold text-slate-800 dark:text-theme-on-accent tracking-normal leading-none">{active}</h3>
        ...
        <div className="glass-card p-4 rounded-2xl flex flex-col justify-between">
          ...
          <div className="mt-4">
            <h3 className="text-3xl font-bold text-slate-800 dark:text-theme-on-accent tracking-normal leading-none">{treatment}</h3>
            <p className="text-[10px] text-slate-600 dark:text-slate-350 font-semibold mt-1 leading-none">
        ...
        <div className="glass-card p-4 rounded-2xl flex flex-col justify-between">
          ...
          <div className="mt-4">
            <h3 className="text-3xl font-bold text-slate-800 dark:text-theme-on-accent tracking-normal leading-none">{followUp}</h3>
            <p className="text-[10px] text-slate-600 dark:text-slate-350 font-semibold mt-1 leading-none">
        ...
        <div className="glass-card p-4 rounded-2xl flex flex-col justify-between">
          ...
          <div className="mt-4">
            <h3 className="text-3xl font-bold text-slate-800 dark:text-theme-on-accent tracking-normal leading-none">{discharged}</h3>
            <p className="text-[10px] text-slate-600 dark:text-slate-350 font-semibold mt-1 leading-none">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="glass-card rounded-2xl p-5 flex flex-col justify-between">
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <h3 className="text-sm font-bold text-slate-800 dark:text-theme-on-accent leading-snug">Oncology Category Distribution</h3>
            </div>
          </div>
              ...
              sortedOncology.map(([category, count]) => {
                ...
                return (
                  <div key={category} className="space-y-1.5">
                    ...
                    <div className="w-full bg-natural-card dark:bg-slate-700/60 rounded-full h-2 overflow-hidden">
                      <div 
                        className="bg-natural-accent dark:bg-natural-gold h-full rounded-full transition-all duration-500"
                        style={{ width: `${percent}%` }}
                      />
                    </div>
                  </div>
        ...
        <div className="glass-card rounded-2xl p-5 flex flex-col justify-between">
          <div>
            <div className="flex items-center gap-2 mb-1">
              <UserSquare className="h-4 w-4 text-natural-brown" />
              <h3 className="text-sm font-bold text-slate-800 dark:text-theme-on-accent leading-snug">Gender & Age Bracket Distribution</h3>
            </div>
          </div>
            ...
            {total === 0 ? (
              ...
              <div className="space-y-3 text-xs">
                ...
                <div className="space-y-1">
                  ...
                  <div className="w-full bg-natural-card dark:bg-slate-700/60 h-2 rounded-full overflow-hidden">
                    <div 
                      className="bg-natural-accent h-full rounded-full" 
                ...
                <div className="space-y-1">
                  ...
                  <div className="w-full bg-natural-card dark:bg-slate-700/60 h-2 rounded-full overflow-hidden">
                    <div 
                      className="bg-natural-brown h-full rounded-full" 
          ...
          <div className="border-t border-natural-border/45 dark:border-slate-700/80 pt-4 mt-6">
              ...
              {Object.entries(ageBrackets).map(([bracket, count]) => {
                ...
                return (
                  <div key={bracket} className="flex-1 flex flex-col justify-end h-full group text-center cursor-help">
                    ...
                    <div 
                      className="bg-natural-accent dark:bg-natural-accent/80 rounded-t-sm hover:bg-natural-accent-dark transition-all duration-305 w-full"
