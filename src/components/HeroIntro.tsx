...
export const HeroIntro: React.FC<HeroIntroProps> = ({ appName, tagline, duration = 1500, onDone }) => {
  ...
  return (
    <div
      className={`fixed inset-0 z-[100] flex flex-col items-center justify-center bg-gradient-to-br from-natural-bg via-natural-sidebar to-natural-border dark:from-slate-900 dark:via-slate-850 dark:to-slate-800 transition-opacity duration-300 ${fading ? "opacity-0" : "opacity-100"}`}
    >
