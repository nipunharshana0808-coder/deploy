...
import { PatientRecord, DiskFile } from "../types";
...
export default function PatientDetailsModal({
  ...
  const UploadProgressBar = () => (
    <div className="mt-3 rounded-2xl border border-[#D9D5CB]/70 dark:border-slate-700 bg-white/55 dark:bg-slate-900/55 p-3 shadow-inner w-full md:w-80">
      <div className="flex items-center justify-between gap-3 mb-2">
        <div className="flex items-center gap-2 min-w-0">
          <span className="h-2.5 w-2.5 rounded-full bg-[#A98467] animate-pulse" />
      ...
      <div className="h-2.5 rounded-full bg-[#E8E4DA] dark:bg-slate-800 overflow-hidden relative">
        <div
          className="h-full rounded-full transition-all duration-500 ease-out bg-gradient-to-r from-[#8F6A4F] via-[#D0B49F] to-[#A98467]"
  ...
  return (
    <div className="modal-pop min-h-[calc(100vh-4rem)]">
      <div className="glass-card rounded-2xl w-full min-h-[calc(100vh-6rem)] flex flex-col justify-between shadow-md relative overflow-hidden">
        ...
        <div className="p-4 lg:p-5 border-b border-natural-border bg-white/20 dark:bg-white/5 backdrop-blur-md flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="h-11 w-11 bg-[#7A8C70] rounded-xl flex items-center justify-center text-white font-bold text-base shadow-sm">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h3 className="value-display font-bold text-slate-800 dark:text-white text-base ">
                  {normalizedPatient.title ? `${normalizedPatient.title} ` : ""}{normalizedPatient.first_name} {normalizedPatient.last_name}
                </h3>
                <span className="text-[10px] bg-[#7A8C70]/10 dark:bg-slate-900 text-[#4A5444] dark:text-[#E0DDD2] px-2 py-0.5 rounded-md border border-[#7A8C70]/30 dark:border-slate-700 font-semibold">
          ...
          <div className="flex items-center gap-2 self-start sm:self-center">
            ...
            <button
              ...
              className="inline-flex items-center gap-1 bg-slate-50 hover:bg-[#EBE8E0] dark:bg-slate-705 dark:hover:bg-slate-650 text-slate-750 dark:text-slate-200 py-1.5 px-2.5 border border-[#D9D5CB]/55 rounded-lg text-xs font-semibold cursor-pointer transition-colors"
              title="Download clinical CSV"
            >
              <Download className="h-3.5 w-3.5 text-[#A98467]" />
              <span className="hidden md:inline text-xs">CSV Export</span>
            </button>
            <button
              onClick={handleExportJSON}
              className="inline-flex items-center gap-1 bg-slate-50 hover:bg-[#EBE8E0] dark:bg-slate-705 dark:hover:bg-slate-650 text-slate-755 dark:text-slate-200 py-1.5 px-2.5 border border-[#D9D5CB]/55 rounded-lg text-xs font-semibold cursor-pointer transition-colors"
              title="Download standard JSON metadata"
            >
              <FileSpreadsheet className="h-3.5 w-3.5 text-[#7A8C70]" />
              <span className="hidden md:inline text-xs">JSON Export</span>
            </button>
            
            <button
              onClick={onClose}
              className="inline-flex items-center gap-1.5 bg-slate-50 hover:bg-[#EBE8E0] dark:bg-slate-700/80 dark:hover:bg-slate-650 text-slate-700 dark:text-slate-205 py-1.5 px-2.5 rounded-lg transition border border-[#D9D5CB]/55 text-xs font-bold"
        ...
        {/* Tab Selection Row */}
        <div className="flex border-b border-[#D9D5CB] dark:border-slate-700/80 bg-[#F5F2ED]/60 dark:bg-slate-850 px-5 gap-1">
          <button
            ...
            className={`flex items-center justify-center py-3 px-4 border-b-2 cursor-pointer transition-all ${
              activeTab === "dossier" 
                ? "border-[#7A8C70] text-[#7A8C70] dark:text-[#A0A595]" 
        ...
        <div className="flex-1 p-5 text-xs text-slate-600 dark:text-slate-300">
          ...
          {activeTab === "dossier" && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                {/* Visual Bio block */}
                <div className="bg-[#F5F2ED]/40 dark:bg-slate-900/40 p-4 rounded-xl border border-[#D9D5CB] dark:border-slate-800 flex flex-col justify-between">
                  <div>
                  ...
                  <div className="mt-3 text-[10px] text-slate-500 dark:text-slate-400 font-bold flex items-center gap-1 border-t border-[#D9D5CB]/50 pt-2 leading-none">
                    <User className="h-3.5 w-3.5 text-[#5B6B52] dark:text-[#7A8C70]" />
                ...
                <div className="bg-[#F5F2ED]/40 dark:bg-slate-900/40 p-4 rounded-xl border border-[#D9D5CB] dark:border-slate-800 flex flex-col justify-between">
                  ...
                  <div className="mt-3 text-[10px] text-slate-500 dark:text-slate-400 font-bold flex items-center gap-1 border-t border-[#D9D5CB]/50 pt-2 leading-none">
                    <Building className="h-3.5 w-3.5 text-[#8F6A4F] dark:text-[#A98467]" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-4">
                <div className="p-4 bg-[#F5F2ED]/40 dark:bg-slate-900/20 border border-[#D9D5CB] dark:border-slate-800 rounded-xl">
                  <h4 className="h-subsection mb-2">Direct symptoms / complaints</h4>
                  <p className="leading-relaxed bg-white dark:bg-slate-800/60 p-3 rounded-lg border border-[#D9D5CB]/40 dark:border-slate-800 text-slate-700 dark:text-slate-300">
              ...
              {(() => {
                ...
                return sections.map((sec) => {
                  ...
                  return (
                    <div key={sec.key} className={`border border-[#D9D5CB] dark:border-[#2D3527] rounded-xl overflow-x-auto shadow-xs ${sec.accent}`}>
                      <div className="p-3 bg-[#F5F2ED] dark:bg-slate-850 h-subsection border-b border-[#D9D5CB] dark:border-[#2D3527] text-slate-800 dark:text-white">
                        {sec.title}
                      </div>
                      {sec.customRender ? (
                        sec.customRender()
              ...
              {normalizedPatient.examFindingsTable && normalizedPatient.examFindingsTable.length > 0 && (
                <div className="border border-[#D9D5CB] dark:border-[#2D3527] rounded-xl overflow-x-auto shadow-xs">
                  <div className="p-3 bg-[#F5F2ED] dark:bg-slate-850 h-subsection border-b border-[#D9D5CB] dark:border-[#2D3527] text-slate-800 dark:text-white">
                  ...
                  <table className="w-full text-left">
                    ...
                    <tbody className="divide-y divide-slate-100 dark:divide-slate-700 text-xs text-slate-755 dark:text-slate-300 leading-relaxed">
                      {normalizedPatient.examFindingsTable.map((row, i) => (
              ...
              {(normalizedPatient.provisional_diagnosis || normalizedPatient.final_diagnosis) && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  {normalizedPatient.provisional_diagnosis && (
                    <div className="p-4 bg-[#F5F2ED] dark:bg-slate-850 border border-[#D9D5CB] dark:border-[#2D3527] rounded-xl">
                      <h4 className="h-subsection text-slate-800 dark:text-white mb-2 flex items-center gap-1.5">
                        <ClipboardList className="h-3.5 w-3.5" />
                        Provisional Diagnosis
                      </h4>
                      <p className="leading-relaxed bg-white dark:bg-slate-800/60 p-3 rounded-lg border border-[#D9D5CB] dark:border-[#2D3527] text-slate-700 dark:text-slate-200">
                        {normalizedPatient.provisional_diagnosis}
                      </p>
                    </div>
                  )}
              ...
              <div className="space-y-5">
                ...
                {normalizedPatient.supplementaryDetailsTable && normalizedPatient.supplementaryDetailsTable.length > 0 && (() => {
                  ...
                  const priorityBadge = (p: string) => {
                    ...
                    if (v === "high") return <span className="eyebrow ml-2 px-1.5 py-0.5 rounded bg-rose-100 text-rose-700">High</span>;
                    if (v === "medium") return <span className="eyebrow ml-2 px-1.5 py-0.5 rounded bg-amber-100 text-amber-700">Medium</span>;
                    if (v === "low") return <span className="eyebrow ml-2 px-1.5 py-0.5 rounded bg-slate-100 text-slate-600">Low</span>;
                    return null;
                  };
                  return (
                    <div className="border border-[#D9D5CB] dark:border-[#2D3527] rounded-xl overflow-x-auto shadow-xs">
                      ...
                      <div className="p-3 space-y-3">
                        {headingOrder.map((heading) => {
                          ...
                          return (
                            <div key={heading} className="border border-[#E5E1D8] dark:border-slate-800 rounded-lg overflow-hidden">
                              <div className="h-group px-3 py-1.5 bg-[#FAF8F3] dark:bg-slate-800/40 text-slate-700 dark:text-slate-200 border-b border-[#E5E1D8] dark:border-slate-800">
                                {heading} <span className="text-slate-400 ">({rows.length} {rows.length === 1 ? "cell" : "cells"})</span>
                              </div>
                              {subKeys.map((sub) => (
                                <div key={sub} className="border-b border-[#E5E1D8]/60 dark:border-slate-800/60 last:border-b-0">
                                  {sub && (
                ...
                {([
                  ...
                  return (
                    <div key={sec.key} className={`border border-[#D9D5CB] dark:border-[#2D3527] rounded-xl overflow-x-auto shadow-xs ${sec.accent}`}>
                      <div className="p-3 bg-[#F5F2ED] dark:bg-slate-850 border-b border-[#D9D5CB] dark:border-[#2D3527] flex items-center justify-between gap-2">
                ...
                {(normalizedPatient.surgeryTable?.length || 0) +
                  ...
                  <div className="space-y-4">
                    ...
                    {normalizedPatient.surgeryTable && normalizedPatient.surgeryTable.length > 0 && (
                      <div className="border border-[#D9D5CB] dark:border-[#2D3527] rounded-xl overflow-x-auto shadow-xs">
                        <div className="flex items-center gap-2 p-3 bg-[#F5F2ED] dark:bg-slate-850 h-subsection border-b border-[#D9D5CB] dark:border-[#2D3527] text-slate-800 dark:text-white">
                    ...
                    {((normalizedPatient.icu_done && normalizedPatient.icu_done !== "Not done") || (normalizedPatient.icuTable && normalizedPatient.icuTable.length > 0)) && (
                      <div className="border border-[#D9D5CB] dark:border-[#2D3527] rounded-xl overflow-x-auto shadow-xs">
                        <div className="flex items-center justify-between gap-2 p-3 bg-[#F5F2ED] dark:bg-slate-850 h-subsection border-b border-[#D9D5CB] dark:border-[#2D3527] text-slate-800 dark:text-white">
                          <div className="flex items-center gap-2">
              ...
              <div className="bg-[#F5F2ED] dark:bg-slate-850 p-4 rounded-xl border border-[#D9D5CB] dark:border-slate-800">
                ...
                {normalizedPatient.general_notes && (
                  <p className="mt-2 text-slate-500 select-all border-t border-[#D9D5CB]/50 dark:border-slate-800 pt-2 text-[11px] leading-relaxed italic">
          ...
          {activeTab === "drive" && (
            <div className="space-y-6">
              ...
              <div className="bg-[#F5F2ED] dark:bg-slate-900/40 p-5 rounded-2xl border border-[#D9D5CB] dark:border-slate-700/80 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <div className="flex gap-3">
                  <div className="h-10 w-10 bg-[#7A8C70]/10 dark:bg-[#7A8C70]/20 text-[#7A8C70] rounded-xl flex items-center justify-center border border-[#7A8C70]/30 flex-shrink-0">
                    <Folder className="h-6 w-6 animate-bounce" />
                  </div>
                  <div>
                    <h3 className="font-bold text-slate-150 dark:text-white text-sm">Patient Specific Documents subfolder</h3>
                ...
                <div className="self-stretch md:self-center flex flex-col items-stretch md:items-end">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 bg-[#7A8C70] hover:bg-[#68785E] active:bg-[#4A5444] text-white font-bold text-xs py-2 px-4 rounded-xl shadow-xs cursor-pointer disabled:opacity-50 select-none transition"
                  >
                    {isUploading ? (
                      <>
              ...
              <div className="bg-white dark:bg-slate-850 border border-[#D9D5CB] dark:border-slate-800 rounded-xl p-5">
                <div className="flex items-center gap-2 text-[10px] text-slate-655 dark:text-slate-205 font-bold mb-4 border-b border-slate-100 dark:border-slate-800 pb-2">
                  ...
                  <span>Oncology_Vault</span>
                   &gt; 
                  <span className="text-[#7A8C70] font-semibold truncate">
                    {`${normalizedPatient.first_name || ""}_${normalizedPatient.last_name || ""}`.replace(/\s+/g, "_")}
                  </span>
                </div>

	                {patientFiles.length === 0 ? (
	                  <div className="py-16 text-center border border-dashed border-[#D9D5CB] dark:border-slate-700 rounded-xl">
	                    <FileText className="h-10 w-10 text-[#D9D5CB]/80 mx-auto mb-2 animate-pulse" />
	                    ...
	                    <button
	                      ...
	                      onClick={() => fileInputRef2.current?.click()}
	                      disabled={isUploading}
	                      className="mt-4 inline-flex items-center gap-2 bg-[#A98467] hover:bg-[#8F6A4F] text-white font-bold text-xs py-2 px-4 rounded-xl transition disabled:opacity-60"
	                    >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {patientFiles.map((file) => (
                      <div key={file.id} className="p-4 bg-slate-50 dark:bg-slate-900/35 border border-[#D9D5CB] dark:border-slate-800 rounded-xl hover:border-[#7A8C70] dark:hover:border-blue-500/55 transition">
                        <div className="flex justify-between items-start gap-2">
                          <div className="flex gap-2.5 min-w-0">
                            <div className="h-9 w-9 bg-[#7A8C70]/10 dark:bg-[#7A8C70]/20 text-[#7A8C70] rounded-lg flex items-center justify-center flex-shrink-0 border border-[#7A8C70]/30 text-xs">
                          ...
                          {file.extracted && (
                            <span className="eyebrow bg-[#7A8C70]/10 text-[#4A5444] dark:text-[#E0DDD2] py-0.5 px-2 rounded-md border border-[#7A8C70]/30">
                              AI EXTRACTED
                            </span>
                          )}
                        </div>
          ...
          {activeTab === "chat" && (
            <div className="h-[60vh] flex flex-col justify-between border border-[#D9D5CB] dark:border-[#2D3527] rounded-2xl overflow-hidden bg-slate-50 dark:bg-slate-900/10">
              
              {/* Disclaimer Ribbon */}
              <div className="px-4 py-2.5 bg-[#7A8C70]/10 border-b border-[#D9D5CB] dark:border-[#2D3527] flex items-center gap-2 text-[10px] text-slate-750 dark:text-slate-300">
                <ShieldCheck className="h-4 w-4 text-[#7A8C70] animate-bounce flex-shrink-0" />
                <span>
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-4">
                {chatThread.map((msg, i) => {
                  ...
                  return (
                    ...
                    >
                      <div className={`h-8 w-8 rounded-lg flex items-center justify-center font-bold text-white flex-shrink-0 shadow-sm ${
                        isAI
                          ? "bg-gradient-to-br from-[#7A8C70] to-[#5E6E55] ai-badge-pulse"
                          : "bg-gradient-to-br from-[#A98467] to-[#8A6B52]"
                      }`}>
                      ...
                      <div className={`p-3.5 rounded-2xl tracking-normal leading-relaxed select-text chat-prose ${
                        isAI
                          ? "chat-ai-bubble border border-[#D9D5CB] dark:border-slate-700 text-xs shadow-sm"
                          : "bg-[#7A8C70] text-white dark:bg-[#7A8C70]/90 text-xs shadow-sm"
                      }`}>
                        {isAI ? (
                ...
                {chatLoading && (
                  <div className="flex gap-3 chat-message-in">
                    <div className="h-8 w-8 rounded-lg flex items-center justify-center flex-shrink-0 shadow-sm bg-gradient-to-br from-[#7A8C70] to-[#5E6E55] text-white ai-badge-pulse">
                      <Bot className="h-4 w-4" />
                    </div>
                    <div className="chat-ai-bubble border border-[#D9D5CB] dark:border-slate-700 p-3.5 rounded-2xl shadow-sm">
              ...
              {/* Chat Input form */}
              <form onSubmit={handleSendMessage} className="p-3.5 border-t border-natural-border bg-white/20 dark:bg-slate-850/30 backdrop-blur-xs flex items-center gap-3">
                <input
                  type="text"
                  value={chatMessage}
                  onChange={(e) => setChatMessage(e.target.value)}
                  placeholder={`Ask oncology advisor guidelines concerning ${normalizedPatient.first_name}'s reports...`}
                  className="flex-1 p-2.5 bg-slate-50 dark:bg-slate-900 border border-[#D9D5CB] dark:border-[#2D3527] placeholder-slate-400 dark:placeholder-slate-500 rounded-xl text-xs focus:ring-1 focus:ring-[#7A8C70] focus:border-[#7A8C70]"
                />
                <button
                  type="submit"
                  disabled={chatLoading}
                  className="bg-[#7A8C70] hover:bg-[#68785E] active:bg-[#4A5444] text-white font-bold p-2.5 rounded-xl flex items-center justify-center transition disabled:opacity-50 cursor-pointer"
                >
        ...
        {/* Page actions */}
        <div className="p-4 lg:p-5 border-t border-[#D9D5CB] dark:border-slate-700 bg-[#F5F2ED] dark:bg-slate-800/20 flex justify-between items-center text-xs">
          <div className="flex gap-2">
            <button
              onClick={() => onEdit(patient)}
              className="inline-flex items-center gap-1 bg-[#7A8C70] hover:bg-[#68785E] text-white py-2 px-4 rounded-xl font-bold cursor-pointer transition select-none tracking-wide text-xs"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-1 bg-rose-50 hover:bg-rose-105 dark:bg-rose-950/30 dark:hover:bg-rose-950/60 text-rose-700 dark:text-rose-300 py-2 px-4 rounded-xl font-bold cursor-pointer border border-[#D9D5CB]/40 dark:border-rose-900/30"
            >
