    ...
    case "h2": {
      ...
      return (
        <div
          key={idx}
          style={delay}
          className={`${fadeUp} mt-3.5 mb-2 first:mt-0`}
        >
          ...
          <div className={`mt-1.5 h-0.5 w-12 rounded-full ${p.bar}`} />
        </div>
      );
    }
    case "h3":
      return (
        <h3
          key={idx}
          style={delay}
          className={`${fadeUp} text-[13px] font-bold text-slate-800 dark:text-slate-100 mt-2.5 mb-1`}
        >
          {block.text}
        </h3>
      );
    case "p":
      return (
        <p
          key={idx}
          style={delay}
          className={`${fadeUp} text-[12.5px] leading-relaxed text-slate-700 dark:text-slate-200 my-1.5`}
        >
      ...
      return (
        ...
        >
          {block.items.map((it, j) => (
            <li key={j} className="flex gap-2 text-[12.5px] leading-relaxed text-slate-700 dark:text-slate-200">
